...
public class HsSwitch extends View implements Checkable {
    ...
    public HsSwitch(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public HsSwitch(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public HsSwitch(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if(attrs != null){
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.HsSwitch);
        }
    ...
    protected void drawCheckedText(
            Canvas canvas,
            int color,
            float centerX,
            float centerY,
...
//        paint.setTextAlign(Paint.Align.CENTER);
    ...
    protected void drawUncheckedText(
            Canvas canvas,
            int color,
            float centerX,
            float centerY,
...
//        canvas.drawText("Off", centerX, centerY, paint);
    ...
    public final void setOnClickListener(OnClickListener l) {
        ...
        performHapticFeedback(SoundEffectConstants.CLICK);
    }
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(HsSwitch view, boolean isChecked);
    }
    ...
    private static String optString(TypedArray typedArray,
                                    int idx,
                                    String def
                                    ){
        if(typedArray == null){return def;}
        return typedArray.getString(idx);
    }
    /*******************************************************/
